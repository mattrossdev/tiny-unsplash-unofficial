...
module.exports = (grunt) => {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          "dist/unsplash-unofficial/plugin.js": [
            "src/text/license-header.js",
            scratchPluginMinPath,
          ],
          "dist/unsplash-unofficial/plugin.min.js": [
            "src/text/license-header.js",
            scratchPluginMinPath,
          ],
        },
  ...
  grunt.registerTask("version", "Creates a version file", () => {
    grunt.file.write("dist/unsplash-unofficial/version.txt", BUILD_VERSION);
  });
